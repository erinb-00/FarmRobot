...
def balance_dataset(X, y, method='undersample', random_state=42):
    ...
    if method == 'undersample':
        ...
        # Use a hybrid approach: oversample minority, slightly undersample majority
...
def train_improved_model():
    ...
    # Balance the training data with hybrid approach
    ...
    print(f"After balancing: {counter_balanced}")
    ...
    train_gen, val_gen = create_data_generators(X_train_final, y_train_final, X_val, y_val)
